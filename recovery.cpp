...
Device::BuiltinAction start_recovery(Device* device, const std::vector<std::string>& args) {
  ...
  std::string ver = android::base::GetProperty("ro.palladium.build.version", "");
  std::string release = android::base::GetProperty("ro.palladium.build.status", "");

  std::vector<std::string> title_lines = {
    "Palladium-OS v" + ver + " " + release,
  };
